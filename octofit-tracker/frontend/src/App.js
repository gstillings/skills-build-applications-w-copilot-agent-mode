        ...
        <Routes>
          ...
          <Route path="/" element={
            <div className="card mt-4">
              <img src="https://as1.ftcdn.net/jpg/02/35/69/04/1000_F_235690407_Mp2tDFESZLVeRYTqnyfF0KCzfMsRC2sO.jpg" alt="Boston Terrier" style={{maxWidth:'300px', borderRadius:'16px', margin:'24px auto 0', display:'block'}} />
